...
import io.onemfive.tor.client.core.crypto.ASN1Parser.ASN1BitString;
import io.onemfive.tor.client.core.crypto.ASN1Parser.ASN1Integer;
import io.onemfive.tor.client.core.crypto.ASN1Parser.ASN1Object;
import io.onemfive.tor.client.core.crypto.ASN1Parser.ASN1Sequence;
...
public class RSAKeyEncoder {
	...
	public RSAPublicKey parsePEMPublicKey(String pem) throws GeneralSecurityException {
		try {
			...
			final ASN1Parser.ASN1Object ob = asn1Parser.parseASN1(data);
			final List<ASN1Parser.ASN1Object> seq = asn1ObjectToSequence(ob, 2);
	...
	private byte[] extractPKCS1KeyFromSubjectPublicKeyInfo(byte[] input) {
		final ASN1Parser.ASN1Object ob = asn1Parser.parseASN1(ByteBuffer.wrap(input));
		final List<ASN1Parser.ASN1Object> seq = asn1ObjectToSequence(ob, 2);
	...
	private BigInteger asn1ObjectToBigInt(ASN1Parser.ASN1Object ob) {
		...
		final ASN1Parser.ASN1Integer n = (ASN1Parser.ASN1Integer) ob;
		return n.getValue();
	}
	...
	private List<ASN1Parser.ASN1Object> asn1ObjectToSequence(ASN1Parser.ASN1Object ob, int expectedSize) {
		if(ob instanceof ASN1Parser.ASN1Sequence) {
			final ASN1Parser.ASN1Sequence seq = (ASN1Parser.ASN1Sequence) ob;
	...
	private byte[] asn1ObjectToBitString(ASN1Parser.ASN1Object ob) {
		...
		final ASN1Parser.ASN1BitString bitstring = (ASN1Parser.ASN1BitString) ob;
